...
const char * const rgRegArm[] = {
    ...
    "???",
    "???",
    "fpscr",        // 40  CV_ARM_FPSCR
    "fpexc",        // 41  CV_ARM_FPEXC
    "???",
    "???",
    "???",
    "???",
    ...
    "???",
    "???",
    "fpextra0",     // 90  CV_ARM_FPEXTRA0
    "fpextra1",     // 91  CV_ARM_FPEXTRA1
    "fpextra2",     // 92  CV_ARM_FPEXTRA2
    "fpextra3",     // 93  CV_ARM_FPEXTRA3
    "fpextra4",     // 94  CV_ARM_FPEXTRA4
    "fpextra5",     // 95  CV_ARM_FPEXTRA5
    "fpextra6",     // 96  CV_ARM_FPEXTRA6
    "fpextra7",     // 97  CV_ARM_FPEXTRA7
    "???",
    "???",
    "???",
    "???",
    ...
    "wr8",          // 136 CV_ARM_WR8
    "wr9",          // 137 CV_ARM_WR9
    "wr10",         // 138 CV_ARM_WR10
    "wr11",         // 139 CV_ARM_WR11
    "wr12",         // 140 CV_ARM_WR12
    "wr13",         // 141 CV_ARM_WR13
    "wr14",         // 142 CV_ARM_WR14
    "wr15",         // 143 CV_ARM_WR15
    "wcid",         // 144 CV_ARM_WCID
    "wcon",         // 145 CV_ARM_WCON
    "wcssf",        // 146 CV_ARM_WCSSF
    "wcasf",        // 147 CV_ARM_WCASF
    "wc4",          // 148 CV_ARM_WC4
    "wc5",          // 149 CV_ARM_WC5
    "wc6",          // 150 CV_ARM_WC6
    "wc7",          // 151 CV_ARM_WC7
    "wcgr0",        // 152 CV_ARM_WCGR0
    "wcgr1",        // 153 CV_ARM_WCGR1
    "wcgr2",        // 154 CV_ARM_WCGR2
    "wcgr3",        // 155 CV_ARM_WCGR3
    "wc12",         // 156 CV_ARM_WC12
    "wc13",         // 157 CV_ARM_WC13
    "wc14",         // 158 CV_ARM_WC14
    "wc15",         // 159 CV_ARM_WC15
    "???",
    "???",
    "???",
    "???",
...
//
const char* SzNameC7Reg(USHORT reg, DWORD MachineType){
  static char wszRegNum[64];
  
	switch(reg){
		case CV_ALLREG_LOCALS : return "BaseOfLocals";
		case CV_ALLREG_PARAMS : return "BaseOfParams";
		case CV_ALLREG_VFRAME : return "VFrame";
	}
  // sprintf(wszRegNum, "???(0x%x)", reg);
  switch(MachineType) {
    case CV_CFL_8080:
    case CV_CFL_8086:
    case CV_CFL_80286:
...
const char* SzNameC7Reg(USHORT reg){
